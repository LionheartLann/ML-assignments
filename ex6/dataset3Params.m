...
%%% find optimal C & sigma
%C_search = [0.01, 0.03, 0.1, 0.3, 1, 3, 10, 30];
%sigma_search = [0.01, 0.03, 0.1, 0.3, 1, 3, 10, 30];
%%%% initailize; should be infinity
%min_error = 1000;
%for i = 1:numel(C_search)
%  for j = 1:numel(sigma_search)
%    C_i = C_search(i);
%    sigma_j = sigma_search(j);
%    % Train the SVM
